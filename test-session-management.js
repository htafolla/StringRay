...
class SessionManagementTester {
  ...
  async startServer() {
    ...
    this.serverProcess = spawn('node', ['.opencode/mcps/session-management.server.js'], {
  ...
  async testTools() {
    ...
    try {
      ...
      console.log('✅ session_info: Expected to return detailed session metadata');
      ...
      console.log('✅ session_read: Expected to return formatted message history');
      ...
      console.log('✅ session_search: Expected to return matching message excerpts');
      ...
      console.log('- session_search: Searches for content within session messages');
      console.log('- session_info: Gets metadata and statistics about a session');
