...
const MCP_SERVERS = [
  ...
  },
  {
    ...
    path: `${pathPrefix}dist/plugin/mcps/enhanced-orchestrator.server.js`,
  },
  {
    name: "enforcer",
    path: `${pathPrefix}dist/plugin/mcps/enforcer-tools.server.js`,
  },
  {
    name: "api-design",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/api-design.server.js`,
  },
  {
    name: "architecture-patterns",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/architecture-patterns.server.js`,
  },
  {
    name: "git-workflow",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/git-workflow.server.js`,
  },
  {
    name: "performance-optimization",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/performance-optimization.server.js`,
  },
  {
  ...
  },
  {
    ...
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/testing-strategy.server.js`,
  },
  {
    name: "code-review",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/code-review.server.js`,
  },
  {
    name: "security-audit",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/security-audit.server.js`,
  },
  {
    name: "ui-ux-design",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/ui-ux-design.server.js`,
  },
  {
    name: "refactoring-strategies",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/refactoring-strategies.server.js`,
  },
  {
    name: "testing-best-practices",
    path: `${pathPrefix}dist/plugin/mcps/knowledge-skills/testing-best-practices.server.js`,
  },
];
