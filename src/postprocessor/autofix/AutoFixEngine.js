...
export class AutoFixEngine {
    ...
    async applyFixes(analysis, context) {
        ...
        if (analysis.confidence < this.confidenceThreshold) {
            await frameworkLogger.log('-auto-fix-engine', '-confidence-too-low-analysis-confidence-for-auto-f', 'info', { message: `⚠️  Confidence too low (${analysis.confidence}) for auto-fixes`,
            });
            return {
                success: false,
                appliedFixes: [],
