...
import { promptSecurityValidator, } from "./prompt-security-validator";
...
export class SecurityScanner {
    ...
    async logResults(report) {
        ...
        await frameworkLogger.log('security-scanner', '-total-vulnerabilities-report-summary-totalvulnera', 'info', { message: `📊 Total vulnerabilities: ${report.summary.totalVulnerabilities}`,
        });
