        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    ...
                    case "cancel-agent":
                        const cancelled = await enhancedMultiAgentOrchestrator.cancelAgent(args.agentId);
                        return {
                            content: [
                                {
                                    type: "text",
                                    text: `Agent ${args.agentId} cancellation: ${cancelled ? "SUCCESS" : "FAILED"}`,
                                },
                            ],
                        };
                    ...
                    case "execute-complex-task":
                        ...
                        const results = await orchestrator.executeComplexTask(args.description, args.tasks, args.sessionId);
                        return {
                            content: [
                                {
                                    type: "text",
...
//# sourceMappingURL=enhanced-orchestrator.server.js.map