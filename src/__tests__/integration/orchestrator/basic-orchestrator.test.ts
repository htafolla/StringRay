...
describe('Basic Orchestrator Functionality', () => {
  ...
  it('should execute a single task successfully', async () => {
    ...
    const results = await orchestrator.executeComplexTask('Single task test', [task]);
  ...
  it('should execute multiple independent tasks', async () => {
    ...
    const results = await orchestrator.executeComplexTask('Multiple tasks test', tasks);
