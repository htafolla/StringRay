...
All security audit activities are automatically logged to `docs/REFACTORING_LOG.md` with the following format:

```markdown
## Security Audit Summary - [TIMESTAMP]
...
_Generated by Security Auditor v1.0.0_
```

## Processor Pipeline

The agent utilizes a dedicated processor pipeline for security operations:

### Pre-Processors

- **securityPreValidate**: Input validation and scan preparation
- **vulnerabilityScan**: Automated vulnerability detection

### Post-Processors

- **threatAnalysis**: Risk assessment and impact analysis
- **securityCompliance**: Compliance validation and reporting
