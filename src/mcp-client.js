...
export class MCPClient {
    ...
    async initialize() {
        ...
        try {
            ...
            frameworkLogger.log("mcp-client", `MCP client initialized with ${this.tools.size} tools`, "success", { jobId });
        }
        catch (error) {
    ...
    async callTool(toolName, args = {}) {
        ...
        try {
            frameworkLogger.log("mcp-client", `calling tool ${toolName} on ${this.config.serverName}`, "info", { jobId, args });
            ...
            frameworkLogger.log("mcp-client", `tool ${toolName} executed successfully`, "success", { jobId });
            return result;
        }
        catch (error) {
            frameworkLogger.log("mcp-client", `tool ${toolName} execution failed: ${error instanceof Error ? error.message : String(error)}`, "error", { jobId, error });
            throw error;
        }
    }
    /**
