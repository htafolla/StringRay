...
export class StrRayIntegration {
  ...
  private async loadCodex(): Promise<void> {
    ...
    this.context.hooks.set('codex:inject', codexInjector.createStrRayCodexInjectorHook);
  ...
  private async setupMonitoring(): Promise<void> {
    ...
    this.context.hooks.set('monitor:performance', monitoring.startPerformanceMonitoring);
  ...
  private async setupAnalytics(): Promise<void> {
    ...
    this.context.hooks.set('analytics:optimize', analytics.optimizeAgentAssignment);
  }
...
export function createStrRayIntegration(config: StrRayIntegrationConfig): StrRayIntegration {
