...
export class MockCodexGenerator {
     ...
     */
    static createCompleteCodex(version = '1.2.20') {
     ...
     */
    static createCodexWithViolations() {
        return JSON.stringify({
            version: "1.2.20",
            lastUpdated: "2026-01-06",
            errorPreventionTarget: 0.996,
...
export class MockContextFactory {
     ...
     */
    static createMockTerm(overrides = {}) {
        return {
            number: 1,
...
export class TestDataFactory {
    ...
    static createValidationResult(compliant = true, violationCount = 0) {
        const violations = Array.from({ length: violationCount }, (_, i) => ({
            ...
            severity: ['low', 'medium', 'high', 'blocking'][i % 4]
        }));
        return {
            compliant,
            violations,
...
export class PerformanceTestUtils {
     ...
     */
    static runPerformanceTest(fn, iterations = 100) {
        const results = [];
        const startTime = performance.now();
