...
- auto-format and lint need Prettier/ESLint in the project to do real formatting.
- state-manager persists to `.opencode/state/mcp-state.json` — survives Hermes restarts.
