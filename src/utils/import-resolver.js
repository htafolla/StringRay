...
export class ImportResolver {
    ...
    generateAlternativePaths(moduleName, subPath) {
        ...
        if (this.isDevelopment) {
            ...
            paths.push(`../dist/plugin/${fullModuleName}.js`, `../src/${fullModuleName}.ts`, `./${fullModuleName}.ts`, `../dist/${fullModuleName}.js`);
        }
        else {
            // Built/deployed alternatives
            paths.push(`../src/${fullModuleName}.ts`, `../dist/plugin/${fullModuleName}.js`, `./${fullModuleName}.js`, `../dist/${fullModuleName}.js`);
        }
