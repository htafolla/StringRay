...
describe('Bug Triage Specialist Agent Configuration', () => {
  ...
  describe('Description and System Prompt', () => {
    it('should have appropriate bug triage description', () => {
      expect(bugTriageSpecialist.description).toContain('StrRay Framework bug triage specialist');
      expect(bugTriageSpecialist.description).toContain('systematic error investigation');
