  ...
  rateLimit: z.object({
    ...
    customRules: z.array(z.object({
      ...
      conditions: z.array(z.object({
        type: z.enum(['httpMethod', 'path', 'header', 'queryString', 'sourceIp']),
...
export const AWSAPIGatewayConfigSchema = z.object({
  ...
  usagePlans: z.array(z.object({
    ...
    apiStages: z.array(z.object({
      apiId: z.string(),
      stage: z.string(),
      throttle: z.record(z.string(), z.object({
        burstLimit: z.number(),
        rateLimit: z.number()
      })).optional()
    })).optional()
...
export const AWSCloudFormationTemplateSchema = z.object({
  ...
  Mappings: z.record(z.string(), z.record(z.string(), z.record(z.string(), z.any()))).optional(),
...
export const AzureLoadBalancerConfigSchema = z.object({
  ...
  frontendIPConfigurations: z.array(z.object({
    name: z.string(),
    properties: z.object({
      ...
      publicIPAddress: z.object({
        id: z.string()
      }).optional()
    })
  })),
  backendAddressPools: z.array(z.object({
    name: z.string()
  })).optional(),
  loadBalancingRules: z.array(z.object({
    name: z.string(),
    properties: z.object({
      ...
      loadDistribution: z.enum(['Default', 'SourceIP', 'SourceIPProtocol']).optional()
    })
  })).optional(),
  ...
  rateLimit: z.object({
    ...
    rules: z.array(z.object({
      ...
      matchConditions: z.array(z.object({
        matchVariables: z.array(z.object({
          variableName: z.enum(['RemoteAddr', 'RequestMethod', 'QueryString', 'PostArgs', 'RequestUri', 'RequestHeaders']),
          selector: z.string().optional()
        })),
        operator: z.enum(['Any', 'IPMatch', 'GeoMatch', 'Equal', 'Contains', 'LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual', 'BeginsWith', 'EndsWith', 'RegEx']),
        matchValues: z.array(z.string()),
        transforms: z.array(z.enum(['Lowercase', 'Trim', 'UrlDecode', 'UrlEncode', 'RemoveNulls', 'HtmlEntityDecode'])).optional()
      })),
...
export const AzureAPIManagementConfigSchema = z.object({
  ...
  location: z.string(),
  sku: z.object({
    name: z.enum(['Developer', 'Basic', 'Standard', 'Premium', 'Consumption']).default('Developer'),
...
export const GCPLoadBalancerConfigSchema = z.object({
  ...
  backendService: z.object({
    ...
    protocol: z.enum(['HTTP', 'HTTPS', 'HTTP2', 'TCP', 'UDP', 'GRPC']).default('HTTP')
  }),
  ...
  rateLimit: z.object({
    ...
    rateLimiter: z.object({
      enforceOnKey: z.enum(['ALL', 'IP', 'HTTP_HEADER', 'XFF_IP']).default('IP'),
...
export const InfrastructureConfigSchema = z.object({
  ...
  security: z.object({
    ...
    complianceFrameworks: z.array(z.enum(['SOC2', 'HIPAA', 'PCI-DSS', 'GDPR'])).optional()
  }).optional(),
  ...
  rateLimiting: z.object({
    ...
    ipBasedLimits: z.object({
      enabled: z.boolean().default(true),
      whitelist: z.array(z.string()).optional(),
      blacklist: z.array(z.string()).optional()
    }).optional(),
    endpointLimits: z.record(z.string(), z.object({
