    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (termMatch) {
        ...
        if (line.includes("zero-tolerance") || line.includes("blocking")) {
          currentTerm.zeroTolerance = true;
          currentTerm.enforcementLevel = "blocking";
        } else if (line.includes("high")) {
          currentTerm.enforcementLevel = "high";
        } else if (line.includes("medium")) {
          currentTerm.enforcementLevel = "medium";
        } else {
          currentTerm.enforcementLevel = "low";
        }
      ...
      if (line.toLowerCase().includes("interweave")) {
        context.interweaves.push(line);
      }
      ...
      if (
        ...
        !line.toLowerCase().includes("anti")
      ) {
