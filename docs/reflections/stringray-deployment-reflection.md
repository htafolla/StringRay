...
- **v1.0.7-1.0.4**: Initial deployment issues (MCP config, CLI binary, file inclusion)
- **v1.0.7-1.0.9**: Postinstall script fixes and CLI improvements
- **v1.0.7-1.0.12**: ES module compatibility and path resolution
- **v1.0.7**: Robust environment detection for deployed testing
