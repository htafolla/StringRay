...
export class ComplexityAnalyzer {
    ...
    calculateFileCount(context) {
        ...
        if (desc.includes("single file"))
            return 1;
        if (desc.includes("multiple files"))
            return 5;
        if (desc.includes("entire module"))
            return 10;
        if (desc.includes("system-wide"))
            return 20;
        return 1;
    }
    calculateChangeVolume(context) {
        ...
        if (operation.includes("create"))
            return 50;
        if (operation.includes("modify"))
            return 100;
        if (operation.includes("refactor"))
            return 200;
        if (operation.includes("analyze"))
            return 0;
        if (operation.includes("debug"))
            return 20;
